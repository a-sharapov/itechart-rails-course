...
ActiveRecord::Schema.define(version: 2021_12_12_155653) do
  ...
  create_table "person_categories", force: :cascade do |t|
    ...
    t.index ["person_id", "category_id"], name: "index_person_categories_on_person_id_and_category_id", unique: true

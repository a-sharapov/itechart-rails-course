...
ActiveRecord::Schema.define(version: 20_211_212_155_653) do
  ...
  create_table 'person_categories', force: :cascade do |t|
    ...
    t.index %w[person_id category_id], name: 'index_person_categories_on_person_id_and_category_id', unique: true
  ...
  create_table 'statics', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index ['slug'], name: 'index_statics_on_slug', unique: true
  end
  ...
  create_table 'users', force: :cascade do |t|
    ...
    t.datetime 'updated_at', precision: 6, null: false
    t.string 'slug'
    t.integer 'current_person'
    t.integer 'default_person'
